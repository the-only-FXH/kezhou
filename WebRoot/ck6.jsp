...
<html>
  ...
  <a href="Xiadan/selectbydate2"><font size="5">东区快递</font></a>
  <a href="Xiadan/selectbydate3"><font size="5">西区快递</font></a>
  <a href="Xiadan/selectbydate4"><font size="5">东门菜鸟</font></a>
  
 
   </center>
    <span><font size="5">下单记录共有${count5}条</font></span>
...
<c:forEach items="${list5}" var="xiadan" varStatus="status" >
      	 <tr>      
      		<td>${status.count}</td>
