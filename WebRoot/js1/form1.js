        ...
        switch (id)
{
	...
	regEvent(document.getElementById("submit"),"click",function(e){
		...
		input1=document.getElementById("phone"), 
        value1=input1.value;
		input2=document.getElementById("qhh"), 
        value2=input2.value;
		input3=document.getElementById("rqhh"), 
        value3=input3.value;
		input4=document.getElementById("kdlx"), 
        value4=input4.value;
	
        if(index!==0||value1==""||value2==""||value4=="未选择"){
